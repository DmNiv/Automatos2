...
automato = Automato()
automato.executar("abbc")
automato.executar("abc")
automato.executar("cb")
automato.executar("a")
automato.executar("cab")
automato.executar("ab")
automato.executar("bca")
automato.executar("bc")
automato.executar("")
automato.executar("abb")
automato.executar("abcabcab")
automato.executar("cabcb")
automato.executar("abbacbac")
automato.executar("bcabacab")
automato.executar("bacab")
automato.executar("bcaabb")
automato.executar("abbccbac")
automato.executar("cabcabab")
automato.executar("bcabbc")
automato.executar("ababca")
